...
public class GetOwnerServiceTest {
    ...
    public void should_return_a_list_of_transaction_by_owner() {
        ...
        Mockito.when( mockTransactionRepository.findByOwnerIdOrderByDateAsc(ArgumentMatchers.any(Long.class))).thenReturn(List.of(
        ...
        Assertions.assertNotNull(owners);
        Mockito.verify(mockTransactionRepository, Mockito.atLeastOnce()).findByOwnerIdOrderByDateAsc(2L);
    ...
    public void should_return_a_transaction_by_id() {
        ...
        Assertions.assertNotNull(transactions.getType());
        Assertions.assertEquals(transactions.getType(), 0);
